...
const theme = {
  ...
  'family:box': {
    decorator: 'block relative h-5 w-5 mr-2 rounded-lg bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500',
  ...
  'family:button': {
    input: '$reset inline-flex items-center justify-center active:focus:scale-95 hover:bg-opacity-90 transition-all bg-crayola text-white text-sm font-medium py-3 px-6 rounded-lg focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-x11 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'family:dropdown': {
    ...
    listitem: 'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-crayola aria-selected:bg-crayola aria-selected:text-white',
    loaderIcon: 'ml-auto',
  ...
  slider: {
    ...
    chartBar: 'absolute bottom-0 h-full bg-x11 opacity-[.66] data-[active="false"]:opacity-[.25]',
  },
  taglist: {
  ...
  toggle: {
    ...
    track: 'p-0.5 min-w-[3em] relative rounded-full transition-all bg-x11 peer-checked:bg-blue-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
